...
### Алгоритм решения:
1. Добавить поле father в класс People
2. Два конструктора: с отцом и без
3. Автонаследование при создании:
- Если нет фамилии → берем у отца
- Если нет отчества → создаем "имяОтца + ович"
